...
// Добавление соуса
export const addFetchSauces = createAsyncThunk('sauces/addFetchSauces', async ({ title, description, price, productType, quantity, imgUrl  }) => {
    return await addSauces({ title, description, price, productType, quantity, imgUrl  });
});
